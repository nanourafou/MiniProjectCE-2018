...
public class TriangleTest {
    ...
    Triangle t1=new Triangle(new Point3D(0,0,4),new Point3D(0,0,0),new Point3D(4,0,0), new Color(1,1,1));
    ...
    Triangle t2=new Triangle(new Point3D(4,-4,4),new Point3D(-3,3,5),new Point3D(5,2,5), new Color(1,1,1));
    @Test
