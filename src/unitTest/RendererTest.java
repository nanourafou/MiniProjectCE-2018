...
public class RendererTest {
    ...
    public void basicRendering(){
        ...
        geometries.addGeometry(new Sphere(new Point3D(0, 0, 150), 50, new Color(45, 67, 125), new Material(1, 1, 1, 1, 1)));

        geometries.addGeometry(new Triangle(new Point3D( 100, 0, 149),
                new Point3D(  0, 100, 149),
                new Point3D(100, 100, 149), new Color(java.awt.Color.red), new Material(1, 1, 1, 1, 1)));

        geometries.addGeometry(new Triangle(new Point3D( 100, 0, 149),
                new Point3D(  0, -100, 149),
                new Point3D(100, -100, 149), new Color(2, 3, 4), new Material(1, 1, 1, 1, 1)));

        geometries.addGeometry(new Triangle(new Point3D(-100, 0, 149),
                new Point3D(  0, 100, 149),
                new Point3D(-100, 100, 149), new Color(2, 100, 150), new Material(1, 1, 1, 1, 1)));


        Triangle tr = new Triangle(new Point3D(-100, 0, 149),
                new Point3D(  0,  -100, 149),
                new Point3D(-100, -100, 149), new Color(200, 33, 255), new Material(1, 1, 1, 1, 1));
    ...
    public void colorRendering(){
        ...
        Geometries geometries = scene.getGeometriesManager();
        geometries.addGeometry(new Sphere(new Point3D(0, 0, 150), 50, new Color(java.awt.Color.darkGray), new Material(1, 1, 1, 1, 1)));
        ...
        geometries.addGeometry(new Triangle(new Point3D( 100, 0, 149),
                new Point3D(  0, -100, 149),
                new Point3D(100, -100, 149), new Color(java.awt.Color.YELLOW), new Material(1, 1, 1, 1, 1)));

        geometries.addGeometry(new Triangle(new Point3D(-100, 0, 149),
                new Point3D(  0, 100, 149),
                new Point3D(-100, 100, 149), new Color(java.awt.Color.CYAN), new Material(1, 1, 1, 1, 1)));


        Triangle tr = new Triangle(new Point3D(-100, 0, 149),
                new Point3D(  0,  -100, 149),
                new Point3D(-100, -100, 149), new Color(java.awt.Color.MAGENTA), new Material(1, 1, 1, 1, 1));
        geometries.addGeometry(tr);
