...
public class PlaneTest {
    Plane p1= new Plane(new Vector(0,1,0),new Point3D(0,0,0), new Color(1,1,1), null,null);
    Plane p2= new Plane(new Vector(0,0,1),new Point3D(0,0,0), new Color(1,1,1),null,null);
